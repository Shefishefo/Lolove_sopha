...
@loader.tds
class ILSofakrashMod(loader.Module):
	"""Lublu Sofu in FTG"""
	strings = {
		"name": "LoveSopha"
	}	
	
	async def ilsofakrashcmd(self, message: "telethon.tl.types.Message") -> None:
		"""This Sopha animation..."""
		if not message.out:
			message = await message.respond('ilsofakrash')
		...
		for i in range(8):
			...
			await sleep(0.3)
		for i in ["С", "Софа", "Софа Краш", "Софа Краш❤️❄️)))!"]:
