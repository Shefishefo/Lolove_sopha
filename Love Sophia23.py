...
@loader.tds
class ILSophaMod(loader.Module):
	"""Lublu Sofu in FTG"""
	strings = {
		"name": "LoveSopha"
	}	
	
	async def ilsophia23cmd(self, message: "telethon.tl.types.Message") -> None:
		"""This Sopha animation..."""
		if not message.out:
			message = await message.respond('ilsophia23')
		...
		for i in range(8):
			...
			await sleep(0.3)
		for i in ["I", "I LOVE", "I LOVE SOPHIA", "I LOVE SOPHIA💙💛)))!"]:
